...
public class CrossWalkCarAgent3 : CarAgent
{
    ...
    private bool checkPedastrians()
    {
        ...
        foreach (GameObject ped in listOfPedastrians)
        {
            ...
            if (Vector3.Dot(toTarget, transform.forward) > 0)
            {
                ...
                xCheck = (0 < xDist) && (xDist < 4.5);
                zCheck = (2 < zDist) && (zDist < 10);
           ...
           //if(pedOnTrajectory)  Debug.Log("Riskpoint " + zDist);
    ...
    private void forcedBrake(float brakeForce)
    {
        brake(brakeForce);
        switchLight(true);
    }
